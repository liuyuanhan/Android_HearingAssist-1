...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
    ...
    protected List<Float> mValueTextSizes = null;
    ...
    @Override
    public void setValueTextSizes(List<Float> sizes) {
        mValueTextSizes = sizes;
    }
    ...
    // add by yuzh 返回mValueTextSizes链表
    @Override
    public List<Float> getValueTextSizes() {
        return mValueTextSizes;
    }

    // add by yuzh
    @Override
    public float getValueTextSize(int index) {
        return  mValueTextSizes.get(index % mValueTextSizes.size());
    }
