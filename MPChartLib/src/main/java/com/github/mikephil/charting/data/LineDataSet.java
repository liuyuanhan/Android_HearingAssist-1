...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    private boolean mDrawCross = false; // add by yuzh 画叉

    private boolean mDrawValuesTop = false; // add by yuzh 是否将Values 绘制在顶部
    ...
    protected void copy(LineDataSet lineDataSet) {
        ...
        lineDataSet.mDrawCross = mDrawCross;
    ...
    // add by yuzh
    public void setDrawCross(boolean enable) {
        this.mDrawCross = enable;
    }

    @Override
    public boolean isDrawCrossEnable() {
        return this.mDrawCross;
    }

    // add by yuzh 是否绘制Values在表格顶部
    public void setDrawValuesTop(boolean enable) {
        this.mDrawValuesTop = enable;
    }

    @Override
    public boolean isDrawValuesTop() {
        return this.mDrawValuesTop;
    }
