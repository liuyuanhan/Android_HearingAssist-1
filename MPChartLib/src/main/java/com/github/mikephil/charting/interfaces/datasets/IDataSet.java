...
public interface IDataSet<T extends Entry> {
    ...
    // add by yuzh 用户显示不同的字体大小
    void setValueTextSizes(List<Float> size);
     ...
     * @return
     */
    float getValueTextSize(); // 直接返回mValueTextSize

    // add by yuzh
    float getValueTextSize(int index); // 返回mValueTextSizes中的值

    List<Float> getValueTextSizes();  // 返回mValueTestSizes
