...
//        super(context, R.style.BaseDialogFragmentStyle);
    ...
    public CommonDialog(Context context, int resId, boolean canceledOnTouchOutside) {
//        super(context, R.style.BaseDialogFragmentStyle);
        super(context);
        this.resId = resId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int id = this.resId == 0 ? R.layout.layout_dialog_common : resId;
        ...
        params.width = DensityUtil.dip2px(getContext(), 300);
    ...
    private void initEvent() {
        ...
        btn_right.setOnClickListener(v -> {
            if (onClickBottomListener != null) {
                onClickBottomListener.onRightClick(CommonDialog.this);
            }
        });
        //设置取消按钮被点击后，向外界提供监听
        btn_left.setOnClickListener(v -> {
            if (onClickBottomListener != null) {
                onClickBottomListener.onLeftClick(CommonDialog.this);
            }
        });
    }
    ...
    public CommonDialog setSubTitle(String subTitle) {
