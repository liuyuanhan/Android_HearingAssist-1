...
public class DensityHelper {
    ...
    public static float originalDensity;
    public static float newDensity;
    ...
    /**
     * 重新计算displayMetrics.density, 将不标准的density转为标准。图片使用dp来设计宽高
     * @see #activate()
     * @param context
     */
    public static void resetDensity(Context context) {
        ...
        } else if (displayMetrics.density <= 1f) {
