...
//	private JrtplibUtil mJrtpLibUtil;
	...
	MediaMuxerRtpWrapper(String ip) {
	...
	/*package*/ void addEncoder(final MediaEncoder encoder) {
		/*if (encoder instanceof MediaVideoEncoder) {
			...
			mVideoEncoder = encoder;
				...
				if (mVideoEncoder != null) { throw new IllegalArgumentException("Video encoder already added."); }
				mVideoEncoder = encoder;
			...
			if (mAudioEncoder != null) throw new IllegalArgumentException("Video encoder already added.");
