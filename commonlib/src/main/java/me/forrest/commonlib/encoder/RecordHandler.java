...
//    private VideoEncoderCore mVideoEncoder;
    ...
    public static class EncoderConfig {
        ...
        public EncoderConfig(String filePath, int width, int height, int bitRate, EGLContext sharedEglContext) {
            this.context = null;
        ...
        public EncoderConfig(Context context , String filePath, int width, int height, int bitRate, EGLContext sharedEglContext) {
        ...
        public String toString() {
            return "EncoderConfig: " + width + "x" + height + " @" + bitRate + " to '" + filePath + "' ctxt=" + eglContext;
        }
    }
    ...
    private static class EncoderHandler extends Handler {
        private WeakReference<RecordHandler> mWeakEncoder;

        public EncoderHandler(RecordHandler encoder) {
            mWeakEncoder = new WeakReference<RecordHandler>(encoder);
        }
        ...
        public void handleMessage(Message inputMessage) {
            ...
            RecordHandler encoder = mWeakEncoder.get();
            if (encoder == null) {
    ...
    private void handleStartRecording(EncoderConfig config) {
        ...
        prepareEncoder(config.eglContext, config.width, config.height, config.bitRate, config.filePath);
    }
...
//        drawBox(mFrameNum++);
    ...
    // 准备编码
    private void prepareEncoder(EGLContext sharedContext, int width, int height, int bitRate, String filePath) {
        try {
            final MediaMuxerWrapper muxer = new MediaMuxerWrapper(filePath);
